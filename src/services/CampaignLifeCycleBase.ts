...
import { default as JSONBigInt, default as JSONBigint } from 'json-bigint';
...
class CampaignLifeCycleBase {
  ...
  public async createNewCampaign(
    { fungible_token_id, media, ...params }: createCampaignParams,
   ...
   * @param {string} [card_status="Campaign Complete, Initiating Rewards"] - The status of the campaign card
   *   (optional, defaults to "Campaign Complete, Initiating Rewards").
