  ...
  return (
    ...
    >
      ...
      <g>
        ...
        />
        <polygon fill={ color?? "#5265ff"} points="223.22 236.87 288.9 198.95 288.9 123.05 223.22 160.97 223.22 236.87" />
      </g>
      <g>
        <path fill={ color?? "#5265ff"} d="m420.24,167.52c0-3.91-2.1-7.53-5.5-9.48l-27.49-15.81-32.68-18.8v37.6s0,75.91,0,75.91l65.66-37.78v-31.64Z" />
        <path
          fill={ color?? "#5265ff"}
