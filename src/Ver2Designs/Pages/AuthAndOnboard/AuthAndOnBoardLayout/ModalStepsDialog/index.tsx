...
const ModalStepsDialog = () => {
  const { isSmDeviceModalOpen, currentStep } = useSelector(
  ...
  return (
    ...
    >
      <Box sx={styles.onBoardingStepsModal} id='on-boarding-steps-modal'>
        <Box
          sx={styles.onBoardingStepsModalHeader}
          id='on-boarding-steps-modal-header'
        >
        ...
        <OnBoardingSteps />
        <Box
          sx={styles.onBoardingStepsModalFooter}
          id='on-boarding-steps-modal-footer'
        >
