...
const metadata = {
  ...
  description:
    'Hashbuzz boosts brand communities with incentivized X posts, using project tokens to increase visibility, engagement, and token adoption, creating viral content and long-term loyalty.',
...
const chain =
  import.meta.env.VITE_NETWORK === 'testnet' ? HederaTestnet : HederaMainnet;
