...
const videoURL =
  ...
  'https://www.youtube.com/embed/zqpnoHG3JAk?si=PevOSpAtHML7wOQb&controls=0';

const HowItWorksVideoModal = () => {
  const dispatch = useDispatch();
  const isOpen = useSelector(
    (state: RootState) => state.landingPage.howItWorksModalOpen
  );
        ...
        <Box sx={styles.modalContainer}>
          <Box sx={styles.modalHeader}>
            ...
            <Typography variant='body2' sx={{ mt: 0.5 }}>
              Watch the video below to learn about Hashbuzz’s features and
              benefits.
            </Typography>
          </Box>
