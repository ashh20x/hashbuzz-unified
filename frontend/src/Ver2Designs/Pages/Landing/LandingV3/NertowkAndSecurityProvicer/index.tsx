...
const NextworkAndSecurityProvider = () => {
  ...
  return (
    <Box
      component='section'
      id='network-and-security-provider'
      sx={styles.nexAndSecurityProviderSection}
    >
      <Box
        id='network-and-security-provider-content'
      ...
      >
        <Grid container>
          <Grid sx={styles.content} size={{ xs: 12, md: 8 }}>
            ...
            <p>
              Discover the power of hashbuzz, a dynamic platform that elevates
              brand communities through incentivized 𝕏 posts.
            </p>
          </Grid>
